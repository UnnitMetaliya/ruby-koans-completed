...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # The map method always returns an array but can work on other collections 
  ...
  # File.open is the standard initializer for a File instance, internally it calls the kernel to create a new file descriptor.
  ...
  # However, Ruby has a class that should answer your prayers – Pathname. It allows you to initialize the object with a path, and provides instance methods that delegate to File or FileUtils methods.
