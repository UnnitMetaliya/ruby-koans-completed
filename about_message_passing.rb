...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # The reason for that is that send existed first and only later it was realized that.. 
    # ..the name send might also usefully be used in other contexts, so __send__ was added (that's the same thing that happened with id and object_id by the way).
    # Credits: https://stackoverflow.com/a/4658359/5390996
  end
