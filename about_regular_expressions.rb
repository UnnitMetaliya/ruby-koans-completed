...
class AboutRegularExpressions < Neo::Koan
  ...
  # Answer: It has got something to do wit algorithms.
  # Simply put, alternation (|) takes more steps for retriving output as it backtracks from the beginning if the match is not found.
  # Whereas the character class advances sequantially. That's the catch. 
  # Avoid alternation when possible. Prefer character class to reduce time complexity and space complexity.
  # ------------------------------------------------------------------
